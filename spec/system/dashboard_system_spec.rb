...
RSpec.describe "Dashboard", type: :system do
  ...
  context "When visiting a new dashboard" do
    ...
    it "display organization name unless a logo is set" do
  ...
  it "can scope down what they see in the dashboard using the date-range drop down" do
  ...
  context "inventory" do
    ...
    it "updates inventory totals on dashboard immediately after donations and distributions are made", js: true do
  ...
  it "getting started guide works as expected", js: true do
